    ...
    <div className='mt-10 border-t-2 border-t-green-500 pt-10'>
        ...
        <div className='flex gap-4 flex-wrap py-4 justify-center'>
        {
            companies.map((company, index) => (
                ...
                gap-4 w-60 h-56 shadow-md hover:bg-opacity-70 hover:scale-105 rounded-md'
                >
                ...
                <p className='flex justify-start items-center gap-1 '><FaPeopleGroup /> { company.employees } employees</p>
